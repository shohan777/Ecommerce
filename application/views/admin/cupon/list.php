...
function approve(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>administration/approve?approve_val="+data+"&&tablename=cupon&&id=id&&status=status";
...
function deapprove(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>administration/deapprove?deapprove_val="+data+"&&tablename=cupon&&id=id&&status=status";
			window.location.href=hrefdata;
	}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_title">
                                     <h2>Total cupon (<?php echo $cupon_list->num_rows();?>)</h2>
                                    <h2 style="float:right">
                                    <a href="<?php echo base_url('administration/cupon_registration');?>" class="btn btn-primary">New cupon</a>
                                ...
                                <div class="container">
                                  <table class="table table-striped" width="100%">
                                    ...
                                    <?php
									$i=0;
                                    foreach($cupon_list->result() as $cuponData):
									$id=$cuponData->id;
									...
									?>
                                      <tr>
                                        ...
                                        <td><?php echo $discount.' '.$dis_type; ?></td>
                                         <td> 
                                         	<a href="<?php echo base_url('administration/cupon_registration/'.$id);?>" class="btn btn-default btn-sm">
          										<span class="glyphicon glyphicon-edit"></span> Edit
                                            </a> 
                                            <a href="javascript:void();" onclick="openPage1('<?php echo $id;?>','cupon','id');" class="btn btn-default btn-sm">
