...
<div class="right_col" role="main">
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						    <?php echo form_open_multipart('reports/expanse_reports', 'class="form-horizontal form-label-left"');?>
                                                    ...
                                                    <div class="form-group">                                   
                                                       ...
                                                       <div class="form-group">
                                                        <div class="col-sm-12 text-center">
                                                          ...
                                                          <input type="submit" name="alltran" class="btn btn-danger  btn-xs" value="All Transaction">
