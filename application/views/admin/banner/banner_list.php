...
function approve(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>administration/approve?approve_val="+data+"&&tablename=banner&&id=b_id&&status=status";
...
function deapprove(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>administration/deapprove?deapprove_val="+data+"&&tablename=banner&&id=b_id&&status=status";
			window.location.href=hrefdata;
	}
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_title">
                                    ...
                                    <a href="<?php echo base_url('administration/banner_registration');?>" class="btn btn-primary">New Banner</a>
                                      ...
                                      <tr>
                                        ...
                                        <td><?php echo $bannerTitle; ?></td>
                                         <td><?php if($bimage!=""){?>
                                                ...
                                                <?php } ?></td>
                                         <td> 
                                         	<a href="<?php echo base_url('administration/banner_registration/'.$b_id);?>" class="btn btn-default btn-sm">
