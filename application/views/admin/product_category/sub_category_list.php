                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <h2 style="float:right"><a href="<?php echo base_url('administration/sub_category_registration');?>" class="btn btn-primary">New Sub Category</a></h2>
                                    <div class="clearfix"></div>
									...
									?>
                                      <tr>
                                        ...
                                        <td><?php echo $cat_name; ?></td>
                                         <td> 
                                         	<a href="<?php echo base_url('administration/sub_category_registration/'.$scid);?>" class="btn btn-default btn-sm">
