...
if($categoryUpdate->num_rows()>0){
	 foreach($categoryUpdate->result() as $categoryData);
		 ...
		 $homepage=$categoryData->homepage;
		 $banImage=$categoryData->banImage;
		 $seller_commission=$categoryData->seller_commission;
}
else{
	$cid='';
                ...
                <div class="x_panel">
                    ...
                    <?php echo form_open_multipart('', 'class="form-horizontal form-label-left"');?>
                        <div id="registration_form">	
                            ...
                            <!-- <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Seller Commission (%)<span class="required">*</span>
                                </label>
                                <div class="col-md-5 col-sm-5 col-xs-12">
                                    <input type="number" name="seller_commission" required class="form-control col-md-7 col-xs-12" 
                                    placeholder='Seller Commission' value="<?php echo $seller_commission; ?>"  onFocus="this.placeholder=''" onBlur="this.placeholder='Category Name'">
                                    <?php // echo form_error('category_name', '<p style="color:#ff0000;margin:0;">', '</p>'); ?>
                                </div>
                            </div> -->
                            </div>
                                <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Show Home Page</label>
                                <div class="col-md-5 col-sm-5 col-xs-12"><input type="checkbox" name="homepage" value="<?php echo $homepage; ?>"></div>
                            </div>          
                                <div class="form-group">
