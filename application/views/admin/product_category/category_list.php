...
function approve(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>administration/approve?approve_val="+data+"&tablename=category"+"&id=cid"+"&status=status";
...
function deapprove(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>administration/deapprove?approve_val="+data+"&tablename=category"+"&id=cid"+"&status=status";
			window.location.href=hrefdata;
	}
...
window.location.href='<?php echo base_url();?>administration/sequenceManage?sequence='+updateid+"&&id="+id+"&tbl=category"+"&tid=cid";
}
...
<div class="right_col" role="main">
                        ...
                        <?php echo form_open('', 'name="formUserSearch" id="form_check"');?>
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <a href="<?php echo base_url('administration/category_registration');?>" class="btn btn-primary">New Category </a>
        ...
        <input type="button" id="update" value="Save" style="width:30%;float:left" class="btn btn-primary" onclick="update_sequence(<?php echo $cid;?>);" />
                                        ...
                                        <td width="11%" align="left">
                                         ...
                                         <td> 
                                         	<a href="<?php echo base_url('administration/category_registration/'.$cid);?>" class="btn btn-default btn-sm">
