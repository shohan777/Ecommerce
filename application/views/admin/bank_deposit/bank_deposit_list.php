                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <h2 style="float:right"><a href="<?php echo base_url('administration/bank_deposit_registration');?>" class="btn btn-primary">New Deposit</a></h2>
									...
									?>
                                      <tr>
                                        ...
                                        <td><?php echo $payment_date; ?></td>
                                         <td> 
                                         	<a href="<?php echo base_url('administration/bank_deposit_registration/'.$bd_id);?>" class="btn btn-default btn-sm">
