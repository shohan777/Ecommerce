          ...
          <tr>
            <td height="52" align="left" valign="top">
                ...
                <td colspan="1" valign="bottom">
                	<?php echo form_open('administration/new_return_invoice');?>
                ...
                <table width="100%">
                   <tr>
                    <td colspan="3" align="center">
                        <table width="50%" align="center">
                            <tr>
                                <td width="40%"><input type="button" value="Return Payment" class="btn btn-warning" name="retpay" id="retpay" 
                                ...
                                <td width="40%"><input type="button" value="Cancel Order" class="btn btn-danger" name="cancel" id="cancel" 
                                onclick="cancel_order('<?php echo $orderid;?>','<?php echo $productid;?>','Cancelled');"/></td>
                              </tr>
                        </table>
                    </td>
                  </tr>          
                   <tr>
                    <td colspan="3" align="center">
                    	<div  id="retamount" style="display:none">
                            <input type="text" disabled="disabled" name="retamount" id="retamount" class="form-control" value="<?php echo $pro_price;?>" placeholder="Enter Amount" 
                        ...
                        <div  id="productList" style="display:none; margin:10px auto;">
                             <table width="100%" class="ordertable" border="1">
                              <tr bgcolor="#e5e5e5" class="trTitle">
                                  ...
                                  <td width="18%" align="center" valign="middle">Product Code</td>
                                  <td width="16%" align="center" valign="middle">Product Price</td>
                                  <td width="16%" align="center" valign="middle">Color & Size</td>
                             </tr>
                            <tr>
                              ...
                              <td width="16%" align="center" valign="middle"><input type="text" id="proprice" 
                               style="border:none; background:none;text-align:center; width:100%;" readonly="readonly"/></td>
                              <td width="16%" align="center" valign="middle">
                              <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#myModal">Open Modal</button></td>
                          </tr>
                   ...
                   <tr>
                    <td valign="top" colspan="3">
                        ...
                        <button type="button" onclick="updateNewOrder();" class="btn btn-success btn-submit" id="submitbtn" 
                        style="display:none; margin-top:10px;">Submit</button>
                        <button type="button" onclick="returnPayment('<?php echo $orderid;?>','<?php echo $productid;?>','Refund');" 
                        class="btn btn-success btn-submit" id="submitbtnret" 
                        style="display:none; margin-top:10px;">Submit</button>
                        </span>
...
<div id="myModal" class="modal fade" role="dialog" style="z-index:10000000">
