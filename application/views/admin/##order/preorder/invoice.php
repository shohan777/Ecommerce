					...
					<div class="container">
						<div class="col-sm-12">
							...
							<div class="col-sm-5 col-sm-offset-4">
								...
								<a href="<?php echo base_url('administration/pre_invoice/'.$inv_id.'/?status=print');?>" onclick="javascript:void window.open('<?php echo base_url('administration/pre_invoice/'.$inv_id.'/?status=print');?>','','width=1200,height=600,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=100,top=30');return false;"><i
									...
									<td align="center" colspan="2">
										<table width="100%" align="center">
											...
											<tr>
												...
												<td align="right">
													<h2 style="padding:0; margin:0">TK&nbsp;&nbsp;
														<?php echo number_format($due_amount);?>
													</h2>
												</td>
											</tr>
										</table>
