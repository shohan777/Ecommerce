                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <h2 style="float:right"><a href="<?php echo base_url('administration/customer_registration');?>" class="btn btn-primary">New customer</a></h2>
                                    <div class="clearfix"></div>
	...
	?>
 		...
 		<button type="button" onclick="update_status(<?php echo $order_id;?>);" class="btn btn-primary" style="padding:5px; font-size:12px;">Save</button>            </td>
            ...
            <td align="left" class="section">
            	<a href="<?php echo base_url();?>administration/view_order/<?php echo $order_id;?>" class="btn btn-primary" style="padding:5px; font-size:12px;">View Order</a>
            </td>
		    </tr>
          <?php
  }
