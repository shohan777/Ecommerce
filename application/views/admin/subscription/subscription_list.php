                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_title">
                                     <h2>Total review (<?php echo $subscription_list->num_rows();?>)</h2>
                                ...
                                <div class="container">
                                  <table class="table table-striped" width="100%">
                                    ...
                                    <?php
									$i=0;
                                    foreach($subscription_list->result() as $reviewData):									
									$id=$reviewData->id;
									...
									?>
                                      <tr>
                                        ...
                                        <td><?php echo $email; ?></td>
                                         <td> 
                                            <a href="javascript:void();" onclick="openPage1('<?php echo $id;?>','subscriptions','id');" class="btn btn-default btn-sm">
