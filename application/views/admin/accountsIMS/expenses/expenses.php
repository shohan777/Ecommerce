...
<script type="text/javascript">
  ...
  function getHeadList(strURL) {		
	...
	function getSubHeadList(strURL) {		
		...
		//alert(master_head);
		var finalurl = strURL+'?liab_id='+asset+'&masterH='+master_head;
		//alert(req);
		if (req) {
			req.onreadystatechange = function() {
				if (req.readyState == 4) {
	...
	function getSubHeadListEdit(strURL) {		
		var req = getXMLHTTP();
		var asset = document.getElementById('assetE').value;	
		var master_head = document.getElementById('master_headE').value;	
		
		var finalurl = strURL+'?liab_idE='+asset+'&masterHE='+master_head;
		//alert(req);
		if (req) {
			req.onreadystatechange = function() {
				if (req.readyState == 4) {
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane box active" id="list">
                                                    ...
                                                    <table width="100%" class="table table-bordered datatable datatable-show-all" id="table_export">
                                                        ...
                                                        <tbody>
														<?php $count = 1;
                                                        foreach($expensesList->result() as $row):
                                                              $asset		= $row->asset;
                                                            ...
                                                            if($asset==1){
                                                                $asset_name = 'Current asset';
                                                                $queryMaster = $this->db->query("SELECT * FROM current_asset_master_head WHERE camh_id='".$master_head."'");
                                                            ...
                                                            elseif($asset==2){
                                                                $asset_name = 'Fixed asset';
																$queryMaster = $this->db->query("SELECT * FROM fixed_asset_master_head WHERE famh_id='".$master_head."'");
                                                                $mrow = $queryMaster->row_array();
																$mHead = $mrow['title'];
                                                                
                                                                $querySub = $this->db->query("SELECT * FROM fixed_asset_sub_head WHERE fash_id='".$sub_head."'");
                                                                $srow = $querySub->row_array();
																$sHead = $srow['title'];
                                                            }
                                                            ...
                                                            <tr>
                                                                ...
                                                                <div class="btn-group">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                                                        ...
                                                                        <li class="divider"></li>
                                                                        <li><a href="javascript:void();" onclick="openPage1('<?php echo $row->r_id;?>','expenses','r_id');" 
                                                              ...
                                                              <div class="modal-body">
																   ...
																   <div class="col-sm-11 col-sm-offset-1" style="margin-bottom:30px;">
                                                                        ...
                                                                        <div class="form-group" style="margin:7px;">
                                                                            <label class="control-label col-md-4 col-sm-4 hidden-xs">asset
                                                                            <span class="required">*</span></label>
                                                                            <div class="col-md-8 col-sm-12 col-xs-12">
                                                                            <select name="asset" id="assetE" required class="form-control col-md-7 col-xs-12"
                                                                            onChange="getHeadListEdit('<?php echo base_url($urlname);?>/ajaxExpAccountsData?assetE='+this.value);">
                                                                                <option value="<?php echo $asset;?>"><?php echo $asset_name;?></option>
                                                        ...
                                                        <?php echo form_open_multipart('', 'class="form-horizontal form-label-left"');?>
                                                               <div class="col-sm-6 col-sm-offset-2">
                                                                        ...
                                                                        <div class="form-group" style="margin:7px;">
                                                                            ...
                                                                            <span class="required">*</span></label>
                                                                            <div class="col-md-8 col-sm-12 col-xs-12">
                                                                            <select name="asset" id="asset" required class="form-control col-md-7 col-xs-12"
                                                                            onChange="getHeadList('<?php echo base_url($urlname);?>/ajaxExpAccountsData?asset='+this.value);">
