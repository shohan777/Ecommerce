                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <h2 style="text-align:right; float:right"><a href="<?php echo base_url('administration/pre_internal_cost_print/print');?>" onclick="javascript:void window.open('<?php echo base_url('administration/pre_internal_cost_print/print');?>','','width=1100,height=400,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=200,top=30');return false;"><i class="fa fa-print"></i> Print</a></h2>
