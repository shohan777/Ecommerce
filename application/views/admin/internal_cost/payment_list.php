                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <h2 style="float:right"><a href="<?php echo base_url('administration/internal_cost_registration');?>" class="btn btn-primary">New payment</a></h2>
                                    <div class="clearfix"></div>
									...
									?>
                                      <tr>
                                        ...
                                        <td><?php echo $payment_date; ?></td>
                                         <td> 
                                         	<a href="<?php echo base_url('administration/internal_cost_registration/'.$pay_id);?>" class="btn btn-default btn-sm">
