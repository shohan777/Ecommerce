...
function approve(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>administration/approve?approve_val="+data+"&tablename=supplier"+"&id=user_id"+"&status=active";
...
function deapprove(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>administration/deapprove?approve_val="+data+"&tablename=supplier"+"&id=user_id"+"&status=active";
			window.location.href=hrefdata;
	}
                        ...
                        <?php echo form_open('', 'name="formUserSearch" id="form_check"');?>
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <a href="<?php echo base_url('administration/supplier_registration');?>" class="btn btn-primary">New supplier</a>
									...
									?>
                                      <tr>
                                        ...
                                        <td width="9%" align="left">
                                         ...
                                         <td> 
                                         	<a href="<?php echo base_url('administration/supplier_registration/'.$supplier_id);?>" class="btn btn-default btn-sm">
