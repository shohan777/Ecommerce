<div class="right_col" role="main">
    <div class="">
        ...
        <div class="x_content">
        <div class="container">
        <form name="form" id="form" action="" method="post" onsubmit="return pre_checkInvoice()">
        ...
        <td class="date">:</td>
        <td><span class="date">
        <input name="minvoice" type="text" id="minvoice" onKeyPress="return pre_checkInt(event, '');pre_hoverChange(this.id)" onblur="pre_checkManual()" class="form-control" tabindex="1">
        </span></td>
        <td>&nbsp;</td>
        ...
        <td align="center">
          <input name="qty" type="text" class="vertical input_ form-control" id="qty" onKeyPress="return pre_checkInt(event, '')" onkeyup="checkQtyP()" maxlength="8"></td>
        ...
        <input type="button" name="Submit" value="Submit" class="btn btn-primary" style="background-color:#093" onclick="pre_checkInvoice()" id="save2" />
