...
window.location.href='<?php echo base_url('administration/pre_update_sequence');?>?sequence='+updateid+"&&id="+id;
}
</script>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <h2 style="float:right"><a href="<?php echo base_url('administration/pre_pre_asset_investment_registration');?>" class="btn btn-primary">New Asset & Investment</a></h2>
                                    <div class="clearfix"></div>
									...
									?>
                                      <tr>
                                        ...
                                        <td><?php echo $asset_investmentTitle; ?></td>
                                         <td> 
                                         	<a href="<?php echo base_url('administration/pre_asset_investment_registration/'.$par_id);?>" class="btn btn-default btn-sm">
