...
function reportsAjaxInline()
{
	...
	//alert(todate);
		$.ajax({
			   type: "GET",
			   url: '<?php echo base_url('administration/closed_order_reports_ajax')?>',
                                          ...
                                          <div style="font-size:18px; border-bottom:1px solid #ccc; float:left; width:100%; margin-bottom:5px;"></div>
                                              <table width="48%">
                                                <tr style="border-bottom:1px solid #003333">
                                                  <td width="290" height="33" align="left"><strong>Particulars</strong></td>
                                                  <td width="201" align="center"><strong>No. of Orders</strong> </td>
                                                  <td width="125" align="center"><strong>Show Details</strong> </td>
                                              </tr>
                                                <tr id="closedOrder">
                                                  <td width="290" height="33" align="left">Total Closed Orders</td>
                                                  <td width="201" align="center"><?php echo $closedOrder->num_rows();?></td>
                                                  <td width="125" align="center"><input type="radio" id="torder" name="orderstatus" value="closedOrder" 
                                                  onclick="reportsAjaxInline();"/></td>
                                              	</tr>
                                                <tr id="successOrder">
                                                  <td width="290" height="33" align="left">Successfully Delivered</td>
                                                  <td width="201" align="center"><?php echo $successOrders;?></td>
                                                  <td width="125" align="center"><input type="radio" name="orderstatus" value="successOrder" 
                                                  onclick="reportsAjaxInline();"/></td>
                                              	</tr>
                                                <tr id="returnOrder">
