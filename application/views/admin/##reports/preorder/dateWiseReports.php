...
function reportsAjax()
{
	...
	var todate=document.getElementById('to_date').value;
		...
		$.ajax({
			   type: "GET",
			   url: '<?php echo base_url('administration/datewise_reports_ajax')?>',
                ...
                <div class="">
                    ...
                    <div class="page-title">
                        ...
                        <div class="title_right">
                            <h2 style="text-align:right; float:right"><a href="<?php echo base_url('administration/datewise_reports/print');?>" onclick="javascript:void window.open('<?php echo base_url('administration/datewise_reports/print');?>','','width=1100,height=400,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=200,top=30');return false;"><i class="fa fa-print"></i> Print</a></h2>
                        </div>
                    </div>
