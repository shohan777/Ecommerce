                ...
                <div class="row">
                    ...
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Closed Order Reports</h3>
                      </div>
                        <div class="title_right">
                            <h2 style="text-align:right; float:right"><a href="<?php echo base_url('administration/closed_order_reports/print');?>" onclick="javascript:void window.open('<?php echo base_url('administration/closed_order_reports/print');?>','','width=1100,height=400,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=200,top=30');return false;"><i class="fa fa-print"></i> Print</a></h2>
                        </div>
                    </div>
                            ...
                            <div class="x_panel">
                                ...
                                <div style="width:100%"><?php echo $this->session->flashdata('successMsg');?></div>
                                          ...
                                          <table width="100%" class="ordertable">
											...
											?>
                                             ...
                                             <?php } ?>                       
                                              ...
                                              <td width="157" align="center">Closing Date </td>
                                    </tr>
											<?php
                                                $i=0;
                                      ...
                                      <tr class="trCont" bgcolor="<?php echo $c; ?>">
                                          ...
                                          <td align="left"><?php echo $closingDate;?></td>
                                    </tr>
                                    <?php
									  }
									  ?>
