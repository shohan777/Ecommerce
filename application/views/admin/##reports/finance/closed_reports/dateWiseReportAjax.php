...
function reportsAjaxInline()
{
	...
	//alert(todate);
		$.ajax({
			   type: "GET",
			   url: '<?php echo base_url('administration/closed_order_reports_finance_ajax')?>',
                                          ...
                                          <div style="font-size:18px; border-bottom:1px solid #ccc; float:left; width:100%; margin-bottom:5px;"></div>
                                              <table width="70%">
                                                ...
                                                <tr id="closedOrder">
                                                  ...
                                                  <td width="133" align="center"><input type="radio" id="torder" name="orderstatus" value="closedOrder" 
