				...
				<div class="page-header">
					...
					<div class="breadcrumb-line breadcrumb-line-component" style="margin-top:10px; margin-bottom:10px;">
						<ul class="breadcrumb" style="font-size:20px;margin-left:20px;">
							<li>Current Liabilities Master Head Information</li>
						</ul>
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane box active" id="list">
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="table table-bordered datatable datatable-show-all" id="table_export">
                                                        ...
                                                        <tbody>
                                                            <?php $count = 1;
															foreach($current_liabilities_master_head_list->result() as $row):
																$title = $row->title;
																$code = $row->code;
																$details = $row->details;
															?>
                                                            <tr>
                                                                ...
                                                                <div class="btn-group">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                                                        ...
                                                                        <!-- EDITING LINK -->
                                                                        <li><a href="#" data-toggle="modal" data-target="#editModal<?php echo $row->clmh_id;?>" style="color:#FF9900">
                                                                        <i class="glyphicon glyphicon-pencil"></i>Edit</a></li>
                                                                        <li class="divider"></li>
                                                                        <li><a href="javascript:void();" onclick="openPage1('<?php echo $row->clmh_id;?>','current_liabilities_master_head','clmh_id');" 
                                                                        style="color:#ff0000"><i class="glyphicon glyphicon-trash"></i>Delete</a></li>
                                                                    </ul>
                                                                </div>                                                                </td>
                                                            </tr>
                                                            <div id="editModal<?php echo $row->clmh_id;?>" class="modal fade" role="dialog">
                                                          ...
                                                          <?php echo form_open_multipart('', 'class="form-horizontal form-label-left"');?>
                                                            <div class="modal-content">
                                                              ...
                                                              <div class="modal-footer">
                                                                 <input type="hidden" name="clmh_id" value="<?php echo $row->clmh_id; ?>">
