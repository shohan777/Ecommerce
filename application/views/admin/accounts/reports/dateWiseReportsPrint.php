...
<div class="content-wrapper" style="background:#fff">
                    <div style="width:100%; float:left">	
                                            ...
                                            <img src="<?php echo base_url('asset/admin/images/soft_transLogo.png')?>" style="width:15%; height:auto" />
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div style="width:100%"><?php echo $this->session->flashdata('successMsg');?></div>
                                        <div class="container">
                                        	<table align="center" width="50%" border="1" cellpadding="0" cellspacing="0" cellpadding="tableDesign">
                                              				<tr>
                                                    ...
                                                    <div class="row">
                                                      <div class="col-md-12">
                                                          ...
                                                          Total Expenses</div>
                                                           <table cellpadding="0" cellspacing="0" border="1" width="100%" cellpadding="tableDesign">
                                                            <tr bgcolor="#eaeaea">
