				...
				<div class="page-header">
					...
					<div class="breadcrumb-line breadcrumb-line-component" style="margin-top:10px; margin-bottom:10px; ">
						<ul class="breadcrumb" style="font-size:20px;margin-left:20px;">
							<li>Opening Asset Information</li>
						</ul>
                                   ...
                                   <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <ul class="nav nav-tabs bordered" style="margin:10px 10px 10px 10px;">
                                                <li class="active">
                                                    <a href="#list" data-toggle="tab"><i class="entypo-list"></i>Asset List</a></li>
                                                <li>
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane box active" id="list">
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="table table-bordered datatable datatable-show-all" id="table_export">
                                                        ...
                                                        <tbody>
                                                            <?php $count = 1;
															foreach($opening_liabilities_list->result() as $row):
																$emh_id = $row->emh_id;
																$title = $row->title;
																$code = $row->code;
																$amount = $row->amount;
                                                            ...
                                                            <tr>
                                                                ...
                                                                <div class="btn-group">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                                                        ...
                                                                        <!-- EDITING LINK -->
                                                                        <li><a href="#" data-toggle="modal" data-target="#editModal<?php echo $emh_id;?>" style="color:#FF9900">
                                                                        <i class="glyphicon glyphicon-pencil"></i>Edit</a></li>
                                                                        <li class="divider"></li>
                                                                        <li><a href="javascript:void();" onclick="openPage1('<?php echo $emh_id;?>','opening_liabilities','emh_id');" 
                                                                        style="color:#ff0000"><i class="glyphicon glyphicon-trash"></i>Delete</a></li>
                                                                    </ul>
                                                                </div>                                                                </td>
                                                            </tr>
                                                            <div id="editModal<?php echo $emh_id;?>" class="modal fade" role="dialog">
                                                          ...
                                                          <?php echo form_open_multipart('', 'class="form-horizontal form-label-left"');?>
                                                            <div class="modal-content">
                                                              ...
                                                              <div class="modal-body">
                                                                   <div class="col-sm-11 col-sm-offset-1" style="margin-bottom:30px;">
                                                                         ...
                                                                         <div class="form-group" style="margin:7px;">
                                                                            ...
                                                                            <div class="col-md-8 col-sm-12 col-xs-12">
                                                                                <input type="text" name="amount" required class="form-control col-md-7 col-xs-12" 
                                                                                placeholder='Amount' value="<?php echo $amount; ?>"  onFocus="this.placeholder=''" 
                                                              ...
                                                              <div class="modal-footer">
                                                                 <input type="hidden" name="emh_id" value="<?php echo $emh_id; ?>">
                                                        ...
                                                        <?php echo form_open_multipart('', 'class="form-horizontal form-label-left"');?>
                                                               <div class="col-sm-6 col-sm-offset-2">
                                                                 ...
                                                                 <div class="form-group" style="margin:7px;">
                                                                    ...
                                                                    <div class="col-md-8 col-sm-12 col-xs-12">
                                                                         <input type="text" name="amount" required class="form-control col-md-7 col-xs-12" 
                                                                                placeholder='Details' value="<?php echo set_value('amount'); ?>"  onFocus="this.placeholder=''" 
                                                                                onBlur="this.placeholder='Details'" 
                                                                                oninvalid="this.setCustomValidity('Please Enter Code')" oninput="setCustomValidity('')">
                                                                             <?php echo form_error('amount', '<p style="color:#ff0000;margin:0;">', '</p>'); ?>
                                                                    </div>
                                                                </div>
