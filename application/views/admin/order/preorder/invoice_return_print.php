                            ...
                            <div class="x_panel">
                              ...
                              <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-5 col-sm-offset-4">
                                      ...
                                      <a href="<?php echo base_url('administration/invoice/'.$inv_id.'/?status=print');?>" onclick="javascript:void window.open('<?php echo base_url('administration/invoice/'.$inv_id.'/?status=print');?>','','width=1200,height=600,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=100,top=30');return false;"><i class="fa fa-print"></i> Print</a>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                              ...
                              <tr bgcolor="#eee" style="opacity:0.5">
                                ...
                                <tr>
                                  ...
                                  <td align="center" class="section">&nbsp;</td>
                                    <td align="center" class="section">&nbsp;</td>
                                   <td align="center" class="section">&nbsp;</td>
                                <td align="center"><h4><strong>TK&nbsp;&nbsp;<?php echo number_format($grand_total).' ( '.$status.')';?></strong></h4></td>
                                   </tr>
                                </table>
                                </div>
