                                    	...
                                    	<div class="modal-dialog" role="dialog">
                                        	<div class="modal-content">
                                        		...
                                        		<div class="modal-body">
                                                	...
                                                	<?php echo form_open('administration/pre_new_invoice');?>
                                      ...
                                      <td align="left"><?php echo $order_time;?></td>
                                    	<td colspan="3" style="padding:0; margin:0">
                                        	<table width="100%" align="center">
													<?php 
													$orderProducts = $this->Index_model->getAllItemTable('pre_orders_products','order_id',$order_id,'','','id','desc');
                                                    foreach($orderProducts->result() as $ordPro){
														$ordproid = $ordPro->product_id;
														$ordQty = $ordPro->qty;
														
                                                        $sql = "SELECT * FROM pre_product WHERE product_id = ?";
														...
														$sqlu = "SELECT * FROM pre_stock_order_product_status WHERE order_id = ? AND product_id = ?";
