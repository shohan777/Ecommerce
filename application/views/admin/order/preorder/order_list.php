                                ...
                                <div class="container">
                                  ...
                                  <table class="table datatable-show-all ordertable" width="100%">
                                    <tr bgcolor="#e5e5e5" class="trTitle">
                                      ...
                                      <td width="68" align="center">Order </td>
                                      <td width="96" align="center">Order On</td>
                                      <td width="91" align="center">Supplier</td>
                                      <td width="57" align="center"> Code </td>
									...
									?>
                                      ...
                                      <td align="left"><?php echo $order_time;?></td>
                                    	<td colspan="3" style="padding:0; margin:0">
                                        	<table width="100%" align="center">
                                                    ...
                                                    <tr>
                                                    	...
                                                    	<td width="5%" align="center"><?php echo $pro->pro_code;?></td>
                                        ...
                                        <div style="width:100%; float:left;">
                                         ...
                                         style="width:30%; margin-right:5px; float:left;background:<?php echo $bgclose;?>;" onclick="updateClosedOrder(<?php echo $order_id;?>);">
                                         
                                        <a href="<?php echo base_url();?>administration/pre_view_order/<?php echo $order_id;?>" title="View Order Details" 
                                        style="padding:5px; font-size:12px;width:40%; float:left;" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                                      </div>
                                       </td>
                                    </tr>
                                    <?php
