                            ...
                            <div class="x_panel">
                              ...
                              <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-5 col-sm-offset-4">
                                      ...
                                      <a href="<?php echo base_url('administration/invoice_return/'.$inv_id.'/?status=print');?>" onclick="javascript:void window.open('<?php echo base_url('administration/invoice_return/'.$inv_id.'/?status=print');?>','','width=1200,height=600,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=100,top=30');return false;"><i class="fa fa-print"></i> Print</a>
                                    </div>
                                </div>
                                <div class="col-sm-12">
         ...
         <tr>
								...
								?>
                                 <tr class="table_hover">
                                    <td height="44" align="center"><h6>Returned Product</h6></td>
                                  ...
                                  <td align="center" class="section"><h6><?php echo $old_quantity;?></h6></td>
                              ...
                              <tr bgcolor="#eee" style="opacity:0.5">
                                    <td height="44" align="center"><h6>New Product</h6></td>
                                    <td align="center" class="section"><h6><?php echo $product_namen;?></h6></td>
                                    <td align="center" class="section">
                                   <img src="<?php echo base_url()?>uploads/images/product/main_img/<?php echo $main_imagen;?>" width="100%" height="auto" style="margin:2px;" />
                                 </td>
                                  <td align="center" class="section"><h6><?php echo $pro_coden;?></h6></td>
                                  <td align="center" class="section"><h6><?php echo $new_quantity;?></h6></td>
                                    <td align="center" class="section"><h6><?php echo $unit_pricen;?></h6></td>
                                   <td align="center" class="section"><h6>TK&nbsp;<?php echo $sub_totaln;?></h6></td>
                                   </tr>  
                                ...
                                <tr>
                                  ...
                                  <td align="center" class="section">&nbsp;</td>
                                    <td align="center" class="section">&nbsp;</td>
                                   <td align="center" class="section">&nbsp;</td>
                                <td align="center"><h2><strong>TK&nbsp;&nbsp;<?php echo number_format($grand_total).' ( '.$status.')';?></strong></h2></td>
                                   </tr>
                                </table>
                                </div>
