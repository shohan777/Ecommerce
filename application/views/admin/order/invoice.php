                ...
                <tr>
                    ...
                    <td align="center" colspan="2">
                        <table width="100%" align="center">
                            <tr>
                                <td><h2 style="padding:0; margin:0">Total Amount</h2></td>
                                <td align="right"><h2 style="padding:0; margin:0">TK&nbsp;&nbsp;<?php echo $grand_total;?></h2></td>
                            </tr>
                            <tr>
                                <td><h2 style="padding:0; margin:0">Paid Amount</h2></td>
                                <td align="right"><h2 style="padding:0; margin:0">TK&nbsp;&nbsp;<?php echo $paid_amount;?></h2></td>
                            </tr>
                            <tr>
                                <td><h2 style="padding:0; margin:0">Due Amount</h2></td>
                                <td align="right"><h2 style="padding:0; margin:0">TK&nbsp;&nbsp;<?php echo $due_amount;?></h2></td>
                            </tr>
                        </table>
