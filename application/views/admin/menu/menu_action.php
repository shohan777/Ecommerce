                                   ...
                                   <div id="registration_form">	
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="col-md-5 col-sm-5 col-xs-12">
                                             ...
                                             <input type="hidden" name="page_structure" class="form-control" value="article" />
                                            </div>
                                            <!--<div class="col-md-4 col-sm-4 col-xs-12">
                                                ...
                                                onChange="getMenu('<?php echo base_url();?>administration/ajaxData?root_id='+this.value)">
