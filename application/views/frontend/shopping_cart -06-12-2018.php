...
<div class="row" style="background:#FFF;z-index:-1; position:relative; width:100%; float:left">
    ...
    <div class="col-sm-12" id="content">
        ...
        <div class="col-sm-7 col-sm-offset-3"><h3 class="productblock-title col-sm-5 col-xs-12 pull-left">Shopping Cart &nbsp;<span  class="col-sm-4 col-xs-12 pull-right">(<small><?php echo count($cart);?> Items</small>)</span></h3></div>
	...
	?>
              <tr>
                ...
                <td class="text-center"><a href="<?php echo base_url();?>index/product_details/<?php echo $product_id;?>"><?php echo $item['name'];?></a></td>
                <td class="text-center"><?php echo $pro_code;?></td>
                 <td class="text-center">
                        <div style="width:20px; height:20px; display:inline; text-align:center; background:<?php echo $procolor;?>;">&nbsp;&nbsp;&nbsp;&nbsp;</div>
                        <div class="colsize">Size: <?php echo $prosize;?> </div>
                 </td>
               ...
               <td class="text-center">
               	<div class="cart_quantity">
                        <div class="qty_area_c">
                            ...
                            <input type="text" value="<?php echo  $item['qty'];?>" name="qty" id="proQuantity<?php echo $i;?>" class="qty_cont_c" maxlength="5" size="1"/>
                ...
                <td class="text-center"><?php echo 'BDT '.$item['price'].' Tk';?>
                <input type="hidden" value="<?php echo  $item['price'];?>" name="price" id="price<?php echo $i;?>"/></td>
                <td class="text-center"><?php echo 'BDT '.$item['subtotal'].' TK';?></td>
                <td class="text-center">
      ...
      <div class="buttons">
        <div class="pull-left"><a class="btn" href="javascript:void();" onclick="history.back(-1);" style="background:#2d2d2d;border-radius:5px; padding:10px 15px;">Continue Shopping</a></div>
