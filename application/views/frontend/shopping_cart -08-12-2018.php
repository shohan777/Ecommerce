				...
				<table class="table table-bordered table-responsive" width="100%">
					<thead>
						<tr id="optoin_bar">
							...
							<td class="text-center">Bonus Product Image </td>
					...
					<tbody>
						...
						?>
						<tr>
							<td class="text-center"><a href="<?php echo base_url();?>index/product_details/<?php echo $product_id;?>"><img
									 src="<?php echo base_url()?>uploads/images/product/main_img/<?php echo $main_image;?>" alt="<?php echo $item['name'];?>"
							...
							<td class="text-center">
								<?php 
								if($bonusdvalue){
							echo "Name: ".$bonusdvalue->product_name.", ";
							echo "Price: ".$bonusdvalue->price;
							echo '<img src="'.base_url("uploads/images/product/main_img/thumnail/").$bonusdvalue->thumb.'" alt="karchup-44" style="width:80px; height:auto">';
								}
									// echo "<pre>";
									// print_r($bonusdvalue);
									// echo $bonusdvalue["product_name"];
									// echo $bonusdvalue["price"];
					...
					<tfoot>
						<tr>
							<td colspan="7" align="right">Total products (tax incl.)</td>
