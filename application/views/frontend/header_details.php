...
<head>
	...
	<meta property="og:image" content="http://bargainnshop.com/assets/images/front/butikbdlogo.png" />
	<meta property="og:image:secure_url" content="http://bargainnshop.com/assets/images/front/butikbdlogo.png" />
	<meta property="og:type" content="eCommerce" />
	<meta property="og:url" content="http://bargainnshop.com/" />
...
#view_trolly_frame{
	...
	<script type="text/javascript">
		window.$zopim || (function (d, s) {
			...
			$.src = "//v2.zopim.com/?3b40Hejajzv3KO2jbQOtGCq9oLiXdpV1";
			z.t = +new Date;
			$.
...
<body style="background:#F7F5EE">
	<header id="header">
			...
			<div class="container-fluid">
				<div class="col-sm-12">
                    ...
                    ?>
							...
							<li><a href="javascript:void();" class="big-link loginModel" data-reveal-id="trackorderModel">Track Order
									&nbsp;| &nbsp;</a></li>
							<?php
                    }
                    ?>
							...
							<li><a href="#" style="margin-right:5px;"><i class="fa fa-phone"></i> +880 1772 223 060 | </a></li>
							<li><a href="mailto:bargainnshop@gmail.com" style="margin-right:5px;"><i class="fa fa-envelope"></i>
									bargainnshop@gmail.com</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="container">
					<div class="col-sm-12">
						<div class="col-sm-12 col-lg-2 logo">
							<a href="<?php echo base_url()?>"><img src="<?php echo base_url()?>assets/images/front/butikbdlogo.png" alt="bargainnshop.com" /></a>
						</div>
                         ...
                         ?>
							...
							<div class="col-sm-12 col-lg-2">
								...
								<div class="trollybtn" id="view_trolly" style="cursor:pointer">
									<a href="<?php echo base_url(" cart/shopping_cart")?>" style="text-decoration:none; color:#fff"><span style="padding:5px;"><i
											 class="fa fa-shopping-cart fa-lg"></i></span>
										Cart <span class="bullet">
											<?php echo $totalPro;?></span>
									</a>
								</div>
		...
		<div id="view_trolly_frame" class="container col-sm-4 col-lg-offset-8" style="float:left">
			<iframe frameborder="0" scrolling="no" align="top" style="height:1100px; float:right; padding:0px; margin:0px; width:300px;"
			 src="<?php echo base_url();?>cart/view_trolly"></iframe>
		</div>
	...
	<div id="trackorderModel" class="reveal-modal" style="width:40%; z-index:100000">
		...
		<div class="form-group col-sm-12 col-md-12 col-lg-12">
			...
			<div class="col-sm-8 col-md-8 col-lg-8"> <input name="email" id="email" class="form-control" type="email" required="required"
				 value="<?php echo set_value('email'); ?>" placeholder="Email Address" /></div>
		...
		<div class="form-group col-sm-12 col-md-12 col-lg-12">
			...
			<div class="col-sm-8 col-md-8 col-lg-8"> <input name="password" id="password" class="form-control" type="password"
