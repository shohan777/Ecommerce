...
<div class="container" style="margin:20px auto;position:relative;">
        ...
        <div class="col-sm-3" style="float:right"><?php include('checkoutTrolly.php');?></div>
          ...
          ?>
            <div class="panel panel-default">
                  ...
                  <div class="panel-heading" id="optoin_bar">
                    ...
                    data-toggle="collapse">Step 1: Checkout Options </a></h4>
                  </div>
                            ...
                            <p>I am a New customer</p>
                             ...
                             <div class="col-sm-6" style="margin:0; padding:0">
                                <fieldset>
                                    ...
                                    <div class="form-group required">
                                        <div class="col-sm-10">
                                            <input type="password" class="form-control"   style="margin-bottom:5px;" id="password" placeholder="Password"  name="password">
                                        </div>
                                    </div>
                                    <div class="form-group required">
                                        <div class="col-sm-10">
                                            <input type="password" class="form-control"   style="margin-bottom:5px;" id="confirmpassword" placeholder="Password Confirm"  name="confirmpassword">
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <div class="buttons">
                                    ...
                                    I have read and agree to the <a class="agree" href="<?php echo base_url('content/privacy-policy');?>"><b>Privacy Policy</b></a> and 
		  ...
		  //echo $this->session->userdata('userAccessId');
           ?>  
            <?php echo form_open('checkout/ordersubmitted', array('class'=>'form-horizontal','name'=>'form1','id'=>'form1')); ?>
                  ...
                  <div id="collapse-shipping-address" role="heading">
                    <div class="panel-body">
                    	<div class="col-sm-8 col-sm-offset-2"> 
                            <div class="radio">
                              <label><input type="radio" checked="checked"  value="1" name="same_billing" id="same_billing"> Same as Billing Address</label>
                           ...
                           <div class="row">
                              <p>Please select the preferred payment method to use on this order.</p>
                               ...
                               <div style="font-size:12px;width:100%; margin:auto; float:left; text-align:left; display:none" id="bkashCon">
                                    ...
                                    You have to make the bKash payment on our official bKash number <strong style="color:red;letter-spacing:2px;font-size:15px;"><?php echo $bkash;?></strong> <br />
                                    ...
                                    <input type="text" name="bkash_trnasitionId" id="bkash_trnasitionId" 
                                ...
                                <div style="font-size:12px;width:100%; margin:auto; float:left; text-align:left; display:none" id="rocketCon">
                                    <strong>Dear valuable customer,</strong><br />
                                    You have to make the Rocket payment on our official Rocket number <strong style="color:red;letter-spacing:2px;font-size:15px;"><?php echo $rocket;?></strong> <br />
                                    ...
                                    <input type="text" name="rocket_trnasitionId" id="rocket_trnasitionId" 
                                    style="width:200px; margin:0 0 10px 5px; border:1px solid #999" />
                                    <input type="hidden" name="price" id="price" style="width:200px; margin-left:5px" value="<?php //echo $grandTotalPrice;?>" />
                                </div>
                            </div>
                           <div class="row" style="margin-top:30px;">                  
                              <p><strong>Select Shipping Area</strong></p>
                              <p>
                                 <select class="form-control" name="shippingcharge" onchange="shipCharge();" id="shippingcharge">
                                    <?php  foreach($shippingmethod->result() as $sch){
                                        ?>
                                        <option value="<?php echo $sch->charge;?>"><?php echo $sch->location.' - '.$sch->charge;?></option>
                                       <?php 
                                    }
                                    ?>
                              </select>
                ...
                <div class="buttons">
                <div class="pull-right">
                  <input type="submit" data-loading-text="Loading..." class="btn btn-primary" id="button-confirm" name="confirmorder" value="Confirm Order" 
                  style="background:#5bb75b;border-radius:5px; padding:10px 15px">
                </div>
              </div>
