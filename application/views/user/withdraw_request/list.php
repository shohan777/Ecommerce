                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <h2 style="float:right"><a href="<?php echo base_url('mlmuser/withdraw_request');?>" class="btn btn-primary">New Request</a></h2>
									...
									?>
                                      <tr>
                                        ...
                                        <td><?php echo $status; ?></td>
                                         <td> 
                                         	<a href="<?php echo base_url('mlmuser/withdraw_request/'.$bd_id);?>" class="btn btn-warning btn-xs">
          										<span class="glyphicon glyphicon-edit"></span>
                                            </a> 
                                            <a href="javascript:void();" onclick="openPage1('<?php echo $bd_id;?>','withdraw_requests','id');" class="btn btn-danger btn-xs">
