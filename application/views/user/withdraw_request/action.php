                    ...
                    <div class="row" style="padding:10px">
                       ...
                       <div class="col-sm-8" style="margin:0; padding:0">
                        ...
                        <div class="form-group" style="margin:0 0 5px 0; padding:0">
                            	<label class="control-label col-md-4 col-sm-4 col-xs-12">Expected Date<span class="required">*</span></label>
                        ...
                        <div class="form-group" style="margin:0 0 5px 0; padding:0">
                            <label class="control-label col-md-4 col-sm-4 col-xs-12">Request Amount<span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-lg-8">
